...
from .views import ListJobPositionsView, UploadCVView, ListApplicationsView, ViewJobPositionView, SubmitApplicationView, JobAppliedApplicationsView, LoginView, logout_view, UserCompanyPositionsView, JobMatchingCVsView
